...
import { Phone, Building, Briefcase, MapPin, Heart, ArrowLeft, CheckCircle, Clock, ClipboardList } from "lucide-react";
import Link from "next/link";

export default function ManagerProfileView({ params }) {
  ...
  if (loading) return <div className="p-8 animate-pulse text-slate-500">Retrieving Manager Portfolio...</div>;
  ...
  return (
    <div className="max-w-5xl mx-auto pb-12 animate-in fade-in">
      <div className="mb-8 flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-extrabold text-slate-900">Manager Portfolio</h1>
          <p className="text-slate-500 mt-1">Detailed HR Information & Division Analytics</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-6 text-center">
            <div className="h-24 w-24 bg-gradient-to-tr from-indigo-500 to-purple-400 text-white rounded-full mx-auto flex items-center justify-center text-4xl font-bold shadow-lg mb-4">
            ...
            <div className="inline-flex items-center justify-center bg-indigo-100 text-indigo-800 text-xs px-3 py-1 rounded-full font-bold tracking-wide uppercase">
              {userProfile.role}
            </div>
          ...
          <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-6">
            <h3 className="font-bold text-slate-800 border-b border-slate-100 pb-3 mb-4">Division Task Analytics</h3>
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-indigo-50 rounded-xl">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-semibold text-indigo-900">Total Created</span>
                </div>
                <span className="text-2xl font-black text-indigo-700">{stats.totalTasks}</span>
              </div>
              ...
              <div className="flex items-center justify-between p-4 bg-amber-50 rounded-xl">
                ...
                <span className="text-2xl font-black text-amber-700">{stats.pendingTasks}</span>
              </div>
            </div>
          </div>
        </div>
