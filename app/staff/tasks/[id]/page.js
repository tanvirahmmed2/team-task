...
export default function StaffTaskDetailsPage() {
  ...
  return (
    <div className="animate-in fade-in max-w-5xl mx-auto pb-12">
      <Link href="/staff/tasks" className="text-sm font-medium text-indigo-600 flex items-center gap-2 mb-6 hover:underline w-max">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 mb-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-6 border-t border-slate-100">
          <div>
            <span className="block text-xs font-semibold text-slate-400 uppercase mb-1">Assigned By</span>
            <p className="text-sm font-medium text-slate-800">{task.managerId?.name}</p>
          </div>
          <div>
